...
안녕하세요, **iOS Developer 이태윤**입니다.  
**사용자 흐름과 상태를 기준으로 안정적인 서비스를 설계하는 개발자**입니다.

기능 구현에 그치지 않고  
비동기 처리, 상태 관리, 화면 전환 구조를 함께 고민하며  
**사용자가 혼란 없이 앱을 사용할 수 있는 경험**을 만드는 데 집중합니다.

구조를 먼저 설계하고, 구현의 질을 끌어올립니다. 🌱
...
<img src="https://img.shields.io/badge/RxSwift-B7178C?style=flat-square"/>
<img src="https://img.shields.io/badge/RxFlow-6A5ACD?style=flat-square"/>
<img src="https://img.shields.io/badge/SnapKit-5E5E5E?style=flat-square"/>
<img src="https://img.shields.io/badge/Then-444444?style=flat-square"/>
</p>
